  ...
  return (
    <main className="min-h-screen bg-[#f7f8ff] text-slate-950">
      ...
      <div className="mx-auto grid max-w-7xl gap-6 px-4 py-8 lg:grid-cols-[230px_1fr]">
        ...
        <section key={`${stored?._id ?? "default"}-${stored?.updatedAt ?? 0}-${activeTab}`} className="rounded-[2rem] bg-white p-6 shadow-[0_18px_60px_rgba(29,38,90,0.08)] ring-1 ring-slate-200">
