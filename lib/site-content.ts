...
export const kenckaSiteContent: SiteContent = {
  ...
  replacementFulfillment: {
    ...
    links: [
      { title: "Souhrn legislativy k povinnému podílu zaměstnávání OZP", description: "MPSV", href: "http://portal.mpsv.cz/sz/obecne/prav_predpisy/vyklady/plneni_povinneho_podilu_ozp" },
      { title: "Aktuální zákon č. 435/2004 Sb., o zaměstnanosti – zaměstnávání OZP: §81–83", description: "Zaměstnávání OZP", href: "http://www.mpsv.cz/ppropo.php?ID=z435_2004_2#par81" },
      { title: "Prováděcí vyhláška č. 518/2004 Sb. – výpočet plnění povinného podílu: §17–20", description: "Výpočet plnění", href: "http://www.mpsv.cz/ppropo.php?ID=v518_2004#par16" },
    ],
    closingText: "Pokud máte zájem o tuto službu, neváhejte nás kontaktovat.",
  },
  about: {
  ...
  contact: {
    ...
    items: [
      ...
      { label: "Otevírací doba", value: "pondělí – pátek\n8:00 – 16:30", icon: "Clock" },
      { label: "Sídlo firmy", value: "Ing. Eva Kencká – účetnictví s.r.o.\nDobrovolného 641/8\n198 00 Praha 9\nIČ: 285 20 092", icon: "MapPin" },
    ],
    mapEmbedUrl: "https://www.google.com/maps?q=Hrn%C4%8D%C3%AD%C5%99sk%C3%A1%2042%2F1%2C%20733%2001%20Karvin%C3%A1-Fry%C5%A1t%C3%A1t&output=embed",
  },
