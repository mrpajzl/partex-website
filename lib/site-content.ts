...
export const defaultSiteContent: SiteContent = {
  ...
  replacementFulfillment: {
    ...
    links: [
      { title: "Informace MPSV k zaměstnávání osob se zdravotním postižením", description: "MPSV", href: "https://mpsv.gov.cz/zamestnavani-osob-se-zdravotnim-postizenim" },
      { title: "Aktuální zákon č. 435/2004 Sb., §81–83", description: "Zaměstnávání OZP", href: "https://www.zakonyprolidi.cz/cs/2004-435#p81" },
      { title: "Prováděcí vyhláška č. 518/2004 Sb., §17–20", description: "Výpočet plnění povinného podílu", href: "https://www.zakonyprolidi.cz/cs/2004-518#p17" },
    ],
  ...
  usefulLinks: [
    { title: "ARES", description: "Vyhledávání ekonomických subjektů", href: "https://ares.gov.cz/ekonomicke-subjekty" },
    { title: "Plátci DPH", description: "Čísla účtů pro ekonomickou činnost", href: "https://adisspr.mfcr.cz/adis/jepo/epo/dpr/apl_ramce.htm?R=/adistc/DphReg?ZPRAC=FDPHI1%26poc_dic=2%26OK=Zobraz" },
    { title: "Ověření DIČ v ČR", description: "Registr plátců DPH v ČR", href: "https://adisspr.mfcr.cz/cgi-bin/adis/idph/int_dp_prij.cgi?ZPRAC=FDPHI1&poc_dic=1" },
    { title: "Ověření DIČ v EU", description: "VIES Evropské komise", href: "https://ec.europa.eu/taxation_customs/vies/#/vat-validation?locale=cs" },
    { title: "Finanční úřady", description: "Kontakty Finanční správy", href: "https://financnisprava.gov.cz/cs/kontakty" },
    { title: "Justice", description: "Veřejný rejstřík a Sbírka listin", href: "https://or.justice.cz/ias/ui/rejstrik" },
...
export const kenckaSiteContent: SiteContent = {
  ...
  services: {
    heading: "Co nabízíme?",
    description: "Účetní a mzdové služby na míru vašim požadavkům — přehledně, spolehlivě a s osobním přístupem.",
    cards: [
      {
        title: "Účetnictví",
        icon: "Calculator",
  ...
  pricingCta: {
    eyebrow: "Ceník služeb",
    title: "Podívejte se na cenu našich služeb",
    description: "Naše ceny jsou jasné, přístupné a nic neskrýváme.",
    buttonText: "Zobrazit ceník",
  },
  pricingPage: {
    eyebrow: "Ceník platný od 1. 1. 2024",
    title: "Ceník",
    description: "Přehled cen účetních, daňových, mzdových a souvisejících služeb podle aktuálního webu kencka.cz.",
    sections: [
      {
        title: "Ceník služeb",
        description: "Ceník platný od 1. 1. 2024.",
        items: [
          { service: "Vedení daňové evidence – plátce DPH", price: "Od 1 500 Kč/měsíc" },
          { service: "Vedení účetnictví – neplátce DPH", price: "Od 2 000 Kč/měsíc" },
          { service: "Vedení účetnictví – plátce DPH", price: "Od 2 000 Kč/měsíc" },
          ...
          { service: "Mzdy – 1 zaměstnanec/měsíc", price: "300 Kč" },
          { service: "Mzdy zaměstnance na dotaci/měsíc", price: "400 Kč / 1 zaměstnanec" },
          { service: "Daňové přiznání pro závislou činnost", price: "", children: [
            { service: "§6 daně z příjmů", price: "500 Kč" },
            { service: "příjmy z podnikání, ostatní příjmy", price: "2 000 Kč" },
            { service: "příjmy z podnikání, ostatní příjmy", price: "2 000 Kč", note: "bez účtování, vypracování z dodaných údajů, včetně přehledu o příjmech a výdajích na OSSZ a ZP" },
            { service: "příjmy z podnikání, ostatní příjmy", price: "5 000 Kč", note: "včetně zaúčtování, uzávěrkových operací, apod. včetně přehledu o příjmech a výdajích na OSSZ a ZP" },
          ] },
          { service: "Daňové přiznání pro právnické osoby", price: "Od 3 000 Kč/měsíc", note: "bez účtování, vypracování z dodaných údajů" },
          { service: "Daň z nemovitých věcí (1 ks)", price: "1 000 Kč" },
          { service: "Daň z nabytí nemovitých věcí (1 ks)", price: "1 000 Kč" },
          { service: "Kontrolní hlášení pro DPH (1 ks) dle podkladů", price: "500 Kč" },
          { service: "Daň z přidané hodnoty (1 ks) dle podkladů", price: "500 Kč" },
  ...
  replacementFulfillment: {
    ...
    links: [
      { title: "Informace MPSV k zaměstnávání osob se zdravotním postižením", description: "MPSV", href: "https://mpsv.gov.cz/zamestnavani-osob-se-zdravotnim-postizenim" },
      { title: "Aktuální zákon č. 435/2004 Sb., o zaměstnanosti – zaměstnávání OZP: §81–83", description: "Zaměstnávání OZP", href: "https://www.zakonyprolidi.cz/cs/2004-435#p81" },
      { title: "Prováděcí vyhláška č. 518/2004 Sb. – výpočet plnění povinného podílu: §17–20", description: "Výpočet plnění", href: "https://www.zakonyprolidi.cz/cs/2004-518#p17" },
    ],
    closingText: "Pokud máte zájem o tuto službu, neváhejte nás kontaktovat.",
  },
  about: {
    title: "O nás",
    content: "Naše účetní firma působí ve svém oboru již 30 let, nejdřív jako fyzická osoba a nyní jako s.r.o. Zpracováváme ekonomickou agendu desítkám klientů z celé ČR.\n\nPři naší činnosti dbáme na práva a zájmy našich klientů. Zpracováváme účetnictví jak fyzickým, tak i právnickým osobám a ke každému klientovi přistupujeme individuálně, s plným nasazením, ať se jedná o drobného podnikatele či velkou společnost.\n\nNaše služby poskytujeme externě, tedy v našich prostorách, s veškerým moderním vybavením. Dle dohody jsme schopni naše služby provádět i v prostorách klienta.\n\nNaše firma v současné době zaměstnává 22 zaměstnanců a spolupracuje s odborníky z oblasti daní přímých i nepřímých.\n\nV případě potřeby či na žádost klienta zajistíme zpracování přiznání k daním z příjmů i v prodlouženém termínu podání, tedy do 30. června (tzv. odklad daňového přiznání). Klientům zaručujeme naprostou diskrétnost a mlčenlivost.\n\nSamozřejmostí je, že naše firma je pojištěna proti škodám, které by mohly vzniknout v souvislosti s výkonem naší činnosti.",
  },
  hiring: {
    enabled: true,
  ...
  usefulLinks: defaultSiteContent.usefulLinks,
  footer: {
